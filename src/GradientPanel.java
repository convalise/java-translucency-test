...
public class GradientPanel extends javax.swing.JPanel {
	...
	public static final int GRAD_HORIZONTAL = 0;
	public static final int GRAD_VERTICAL = 1;
	public static final int GRAD_DIAGONAL = 2;
	public static final int GRAD_DIAGONALINVERSE = 3;
	...
	public GradientPanel() {
		this(DefaultColor, DefaultColor, GRAD_VERTICAL, false);
	}

	public GradientPanel(Color StartColor, Color EndColor) {
		this(StartColor, EndColor, GRAD_VERTICAL, false);
	}
